...
desc <- read_delim("../resources/DescriptionLinesFromGenomicsFasta.txt", delim = "\t", col_names = FALSE)
str(desc)
...
# load eggnog results
eggnog <- read_tsv("../resources/out.emapper.annotations", skip = 4)
str(eggnog)
# merge with annoDF
...
# save to rds
saveRDS(mtx, "../resources/methylation_data_EGGnogAnnotated.rds")
